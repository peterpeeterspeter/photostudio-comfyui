#!/usr/bin/env python3
"""
Test Phase 2 Minimal Working Workflow
Tests the minimal Phase 2 pipeline with available components
"""
...
def test_minimal_workflow():
    """Test the minimal Phase 2 workflow"""
    print("🚀 Testing Phase 2 Minimal Workflow...")
    ...
    # Load workflow
    workflow_path = "workflows/phase2_basic_working.json"
                ...
                if status_response.status_code == 200:
                    ...
                    if status.get("status_str") == "success":
                        ...
                        if history_response.status_code == 200:
                            ...
                            if "15" in outputs:  # SaveImage node
                                images = outputs["15"].get("images", [])
                                if images:
...
def main():
    """Main test function"""
    print("🧪 Phase 2 Minimal Workflow Test")
    print("=" * 40)
    ...
    if success:
        print("\n🎉 Phase 2 minimal workflow test PASSED!")
        print("✅ Ready for production testing")
    else:
        print("\n❌ Phase 2 minimal workflow test FAILED!")
